...
El conflicto entre ambos es principalmente juego, complicidad o consecuencia de sus decisiones. No son adversarios maliciosos.

## 4. Lenguaje visual

### Forma
- Siluetas fuertes y reconocibles.
- Cabezas grandes y expresivas.
- Simplificación deliberada.
- Deformación caricaturesca controlada.
- Cuerpos compactos y estilizados, no realistas.
- Legibilidad antes que detalle.
- La identidad debe conservarse incluso en silueta, escala reducida o monocromo.

### Referencias funcionales
- **Rayman Origins:** silueta, elasticidad, deformación expresiva, energía visual y acabado moderno.
- **Chibi / kawaii ácido:** proporciones infantiles, simplificación, ternura y contraste entre apariencia y conducta.
- **Ibáñez / tebeo español:** gestualidad, composición, exageración cotidiana y timing del gag.
...
La comicidad se apoya en inocencia, casualidad, impulsividad, torpeza, orgullo, malentendidos, exageración y consecuencias inesperadas.

## 6. Humor
- Un gag por ilustración.
- Primera lectura inmediata.
- Segunda lectura con sorpresa, ironía, picardía o detalle contextual cuando aporte valor.
- La situación manda; el texto sólo remata cuando sea necesario.
- El humor corporal, facial y gestual debe funcionar sin diálogo.
- Los objetos cotidianos pueden llevarse al extremo manteniendo una lógica reconocible.
- Los detalles de segunda lectura deben ser pocos y precisos.
- La gamberrada nunca debe convertir a los personajes en figuras crueles.

## 7. Andalucía
La prioridad es:

1. **Andalucía estructural:** forma de relacionarse, confianza, picaresca, ritmo, cercanía, códigos sociales, cotidianeidad y actitud.
2. **Andalucía ambiental:** lugares, arquitectura, objetos, gastronomía, paisaje y situaciones cuando sirvan al gag.
3. **Andalucía ornamental:** referencias visuales puntuales para favorecer reconocimiento, evitando acumulación de tópicos.

El objetivo no es ridiculizar Andalucía ni construir una postal folclórica. La identidad debe resultar reconocible al público local y comprensible al público internacional.

Un gag puede desarrollarse en Sevilla, Málaga, una playa, un supermercado de Tokio o una nave espacial sin perder la identidad del universo.
...
El contraste y la jerarquía importan más que la cantidad de colores.

## 9. Efectos
Estallidos de pintura, polvo de color, salpicaduras, partículas y líneas cinéticas pueden utilizarse como puntuación visual.

Regla:

> El efecto sirve a la acción, reacción, composición o remate del gag; no rellena espacio ni genera ruido por sí mismo.
...
### Pisha
Los huevecillos pueden aparecer como recurso anatómico caricaturesco puntual cuando pose, vestuario, composición y gag lo hagan pertinente.

En ambos casos:
- no son elementos obligatorios en todas las imágenes;
- no deben sexualizar al personaje;
- no deben dominar la composición;
- su ausencia no constituye un fallo de canon;
- la decisión depende del contexto y de la función cómica.
...
### Pisha
Movimiento inicialmente contenido. Pausas, observación y pequeñas reacciones. Puede escalar bruscamente cuando se pone nervioso, se enfada consigo mismo o se deja arrastrar por la situación.

La dinámica de movimiento debe ser complementaria, no repetitiva.

## 12. Producción
- Gag primero.
- Silueta después.
- Expresión después.
- Composición y efectos después.
- Detalles al final.
- Si un elemento no mejora el gag, la lectura, la personalidad o la composición, se elimina.
- El diseño debe funcionar como ilustración, pegatina y mercancía.
- La técnica puede cambiar según el soporte sin cambiar la identidad.

## 13. Adaptabilidad
El canon protege identidad semántica, no reproducción pixel a pixel.

Pose, expresión, perspectiva, iluminación, ropa contextual, escenario y composición pueden variar dentro de las reglas correspondientes.
...
- infantil y gamberro;
- tierno y pícaro;
- andaluz y exportable;
- simple y cuidadosamente trabajado;
- reconocible por sus personajes antes que por sus decorados.

La esencia permanece. El universo crece.
