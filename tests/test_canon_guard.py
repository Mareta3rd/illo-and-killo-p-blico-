...
class CanonGuardTests(unittest.TestCase):
    ...
    def test_pisha_requires_clavel(self):
        proposal = {
            "characters": ["pisha"],
            "elements": [
    ...
    def test_pisha_requires_black_spots(self):
        proposal = {
            "characters": ["pisha"],
            "elements": [
    ...
    def test_pisha_with_clavel_is_valid(self):
        proposal = {
            "characters": ["pisha"],
            "elements": [
                {"id": "clavel", "intention": "character_identity"},
                {"id": "black_spots", "count": 4, "intention": "character_identity"},
            ],
        }
        result = validate_piece(proposal, self.KNOWLEDGE)
    ...
    def test_pisha_spots_minimum_is_valid(self):
        proposal = {
            "characters": ["pisha"],
            "elements": [
                {"id": "clavel", "intention": "character_identity"},
    ...
    def test_pisha_spots_maximum_is_valid(self):
        proposal = {
            "characters": ["pisha"],
            "elements": [
                {"id": "clavel", "intention": "character_identity"},
                {"id": "black_spots", "count": 8, "intention": "character_identity"},
            ],
        }
        result = validate_piece(proposal, self.KNOWLEDGE)
        self.assertTrue(result.valid)
    ...
    def test_pisha_spots_below_range_is_violation(self):
        proposal = {
            "characters": ["pisha"],
            "elements": [
                {"id": "clavel", "intention": "character_identity"},
        ...
        self.assertFalse(result.valid)
        self.assertIn(
            "CANON_PISHA_SPOTS_OUT_OF_RANGE",
            {issue.code for issue in result.issues},
        )

    def test_pisha_spots_above_range_is_violation(self):
        proposal = {
            "characters": ["pisha"],
            "elements": [
                {"id": "clavel", "intention": "character_identity"},
                {"id": "black_spots", "count": 9, "intention": "character_identity"},
            ],
        }
        result = validate_piece(proposal, self.KNOWLEDGE)
        self.assertFalse(result.valid)
    ...
    def test_pisha_spots_wrong_color_is_violation(self):
        proposal = {
            "characters": ["pisha"],
            "elements": [
                {"id": "clavel", "intention": "character_identity"},
                {"id": "black_spots", "color": "red", "count": 4, "intention": "character_identity"},
            ],
        }
        result = validate_piece(proposal, self.KNOWLEDGE)
        self.assertFalse(result.valid)
        self.assertIn(
            "CANON_PISHA_SPOTS_COLOR_INVALID",
            {issue.code for issue in result.issues},
        )
